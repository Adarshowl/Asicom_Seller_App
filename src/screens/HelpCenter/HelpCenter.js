    ...
    const contactOptions = [
        {
            ...
            image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1ZKw8Q2sd0AlNMzqbzwAzZPOfiqmU79bP1g&usqp=CAU'
        },
        {
            name: 'Website',
            url: 'https://www.instagram.com/your-instagram-page',
            image: 'https://w7.pngwing.com/pngs/727/737/png-transparent-biodegradation-computer-icons-symbol-website-logo-miscellaneous-symmetry-environmentally-friendly-thumbnail.png'
        },
        {
            name: 'WhatsApp',
        ...
        },
        {
            name: 'Facebook',
            url: 'https://www.facebook.com/your-facebook-page',
            image: "https://i.pinimg.com/originals/e7/34/a1/e734a153a525fbece9673d297c281167.png"
        },
        {
            name: 'Instagram',
            url: 'https://www.instagram.com/your-instagram-page',
            image: 'https://static.vecteezy.com/system/resources/previews/014/414/683/non_2x/instagram-black-logo-on-transparent-background-free-vector.jpg'
        },
        {
            name: 'Twitter',
            url: 'https://www.facebook.com/your-facebook-page',
            image: 'https://toppng.com/uploads/preview/transparent-twitter-logo-white-11549680415asnkhtljtz.png'
        },
                ...
                <TouchableOpacity
                    ...
                    style={[
                        styles.tab,
                        {
                            ...
                            borderBottomWidth: 2,
                            borderBottomColor: selectedTab === 'FAQ' ? theme?.colors?.colorPrimary : theme?.colors?.bg,
                        },
                    ]}
                >
                    <Text
                ...
                <TouchableOpacity
                    ...
                    style={[
                        styles.tab,
                        {
                            // backgroundColor: selectedTab === 'Ongoing' ? 'blue' : 'gray',
                            borderBottomWidth: 2,
                            borderBottomColor: selectedTab === 'Contact' ? theme?.colors?.colorPrimary : theme?.colors?.bg,
                        },]}
                >
                    <Text
                        style={[styles.text, {
