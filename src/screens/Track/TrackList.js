                ...
                <View style={{
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 35, textAlign: 'center', marginBottom: 22, color: theme?.colors?.grey }}>......</Text>
                        </View>
                    </View>
                    <View style={[styles.container, {
                        // marginTop: 8
                    ...
                    <View style={[styles.container, {
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 35, textAlign: 'center', marginBottom: 22 }}></Text>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <FlatList
                                    data={dotData}
                                    renderItem={({ item }) => (
                                        <Text style={{ fontSize: 40, marginVertical: -20, marginTop: -24, marginLeft: 8, color: theme?.colors?.grey }}>.</Text>
                                    )}
                        ...
                        <View style={{
                            ...
                            <View>
                                <View>
                                    ...
                                    }]}>4 Everygreen Street Lake Zunch60047</Text>
                                </View>
                            </View>
                            <View>
                                <View>
                                    ...
                                    }]}>89 Glen Ridge St Ganesville WV 26003</Text>
                                </View>
                            </View>
                            <View>
                                <View>
                                    ...
                                    }]}>89 GHillcreft Wheelinh WV  30736</Text>
                                </View>
                            </View>
                            <View>
                                <View>
                                    ...
                                    <Text style={styles?.title}>32 Manchester Ave Ringgold GA 30736</Text>
                                </View>
                            </View>
