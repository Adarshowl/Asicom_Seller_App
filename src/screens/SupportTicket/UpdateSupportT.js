  ...
  const updateSupport = () => {
    ...
    try {
      const body = {
        updateId: item._id,
        subject: subject,
        category: selectedCategories || item?.category,
        description: description,
      };
      // console.log(body)
      // console.log("response axios >>> ", JSON.stringify(API_END_POINTS.Update_SUPPORT_Ticket));

      ApiCall('post', body, API_END_POINTS.Update_SUPPORT_Ticket, {
        ...
        <View
          ...
          <View
            ...
            <Picker
              ...
              mode="dropdown">
              {/* <Picker.Item label="Select Categories" value={item?.category} /> */}
              <Picker.Item label={'Select Categories'} value={item?.category} />
