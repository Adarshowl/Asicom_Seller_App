...
export const app_logo = require('../assets/images/newlogo.png');
...
export const asicomlogo = require('../assets/images/asicomlogo.jpg');
// export const asicomlogo = require('../assets/images/newlogo.png');
